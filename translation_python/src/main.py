...
"max_distance_travelled": max_distance_travelled,"max_crop":max_crop,"dynamic_beta":dynamic_beta,"beta_vector":beta_vector,"leave_after_max_fail": leave_after_max_fail, 
"max_fails":number_of_max_fails,"forbid_reverse_vector": forbid_reverse_vector,"allow_nest_return": allow_nest_return,"beta": beta,"alpha_pos":alpha_pos,"alpha_neg":alpha_neg,"gamma":gamma,"use_Q_learning":use_Q_learning,
